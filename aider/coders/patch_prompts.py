...
You have the ability to search the web and access real-time information if it helps solve the user's problem. Provide accurate and well-reasoned answers.
{final_reminders}
